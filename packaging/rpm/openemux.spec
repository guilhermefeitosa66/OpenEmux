...
#
# aarch64 joins it (issue #119). Nothing in the app is architecture-specific;
# what is, is the vendored RetroArch, and on ARM there is none to vendor --
# libretro publishes no ARM build -- so the package depends on the
# distribution's instead, below.

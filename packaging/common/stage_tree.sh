...
# and the desktop file + icon register it with the desktop environment.
#
...
install -Dm644 "$ROOT_DIR/packaging/appimage/$APP_ID.desktop" \
  "$DESTDIR/usr/share/applications/$APP_ID.desktop"
install -Dm644 "$ROOT_DIR/src/openemux/ui/assets/images/logo.png" \
